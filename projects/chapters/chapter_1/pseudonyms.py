"""Generate funny names by randomly combing names from 2 separate lists."""

import random


def main() -> None:
    """Choose names at rand from 2 tuples of names and print to screen"""
    print("\nWelcome to the Psych 'Sidekick Picker Name'.\n")
